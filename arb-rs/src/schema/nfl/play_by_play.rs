    ...
    D: Deserializer<'de>,
{
    ...
    match value {
        ...
        serde_json::Value::Null => Ok(None),
        _ => Err(serde::de::Error::custom(
            "Expected string, number, or null for quarter field",
        )),
    }
}
...
pub struct NFLScore {
    ...
    #[serde(rename = "Quarter", deserialize_with = "deserialize_optional_quarter")]
...
pub struct NFLPlayByPlayResponse {
    #[serde(rename = "Score")]
    pub score: Option<NFLScore>,
    #[serde(rename = "Quarters")]
    pub quarters: Option<Vec<NFLQuarter>>,
    #[serde(rename = "TeamGames")]
    pub team_games: Option<Vec<serde_json::Value>>,
    #[serde(rename = "PlayerGames")]
    pub player_games: Option<Vec<serde_json::Value>>,
}

// Type alias for raw JSON to bypass deserialization issues
pub type NFLPlayByPlayResponseUnknown = serde_json::Value;
