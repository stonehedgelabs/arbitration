...
pub struct NFLBoxScoreByScoreIDV3Response {
    #[serde(rename = "Score")]
    pub score: NFLBoxScoreGame,
    #[serde(rename = "Quarters")]
    pub quarters: Vec<NFLBoxScoreQuarter>,
    #[serde(rename = "TeamGames")]
    pub team_games: Vec<NFLBoxScoreTeamGame>,
}
