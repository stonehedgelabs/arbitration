...
export const boxScoreData: Record<string, any> = {
  ...
  'mlb-1': {
    ...
    homeTeam: {
      ...
      abbreviation: 'NYY',
      score: 7,
      quarterScores: [2, 1, 3, 1, 0, 0, 0, 0, 0],
      stats: {
        firstDowns: 0,
        totalYards: 0,
        passingYards: 0,
    ...
    awayTeam: {
      ...
      abbreviation: 'BOS',
      score: 4,
      quarterScores: [1, 0, 1, 0, 1, 0, 1, 0, 0],
      stats: {
        firstDowns: 0,
        totalYards: 0,
        passingYards: 0,
...
export function getLeagueData(leagueId: string) {
  return mockData[leagueId as keyof typeof mockData] || null;
}

export function getBoxScore(gameId: string) {
  return boxScoreData[gameId] || null;
}
