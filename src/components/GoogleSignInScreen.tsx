          ...
          <div className="text-center mb-8">
            ...
            {!showPassword ? (
              <>
                ...
                <p className="text-gray-600">to continue to SportsHub</p>
              </>
            ) : (
              <>
                <h2 className="text-2xl font-normal text-gray-900 mb-2">
              ...
              <form onSubmit={handleEmailNext} className="space-y-6">
                <div className="space-y-2">
                  <Input
                    ...
                    className="h-14 border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md text-base"
                    required
                  />
                </div>
      ...
      <div className="p-4 border-t border-gray-100">
        <div className="flex items-center justify-between text-xs text-gray-500">
          ...
          <div className="flex space-x-4">
            <Button variant="link" className="text-gray-500 text-xs p-0 h-auto">
              Help
            </Button>
            <Button variant="link" className="text-gray-500 text-xs p-0 h-auto">
              Privacy
